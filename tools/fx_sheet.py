...
SPEC = {
    ...
    # ── 2026-08-02 추가 ──────────────────────────────────────────────
    # 금속 단원자 — 불꽃반응 색을 그대로 쓴다(칼슘=주황). 튀는 불티 느낌으로 ✦
    'Ca':     dict(glyph='✦', colors=[(255,171,94),(255,214,150),(255,255,255)], spin=+1),
    # 질소 — 삼중결합이라 반응이 거의 없다. 옅고 조용한 푸른 연기
    'N2':     dict(glyph='○', colors=[(142,197,255),(200,225,255),(240,248,255)], spin=+1),
    # 염소 기체 — 황록색 유독 연기. 소용돌이치듯 반대로 감긴다
    'Cl2':    dict(glyph='●', colors=[(164,232,94),(205,255,140),(230,255,200)], spin=-1),
    # 염화은 앙금 — 흰 결정이 가라앉는다. 각진 마름모, 순백
    'AgCl':   dict(glyph='◆', colors=[(255,255,255),(238,242,250),(210,220,235)], spin=+1),
}
